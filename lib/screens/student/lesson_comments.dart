...
class StudentLessonCommentsScreen extends StatefulWidget {
  ...
  @override
  State<StudentLessonCommentsScreen> createState() =>
      _StudentLessonCommentsScreenState();
}

class _StudentLessonCommentsScreenState
    extends State<StudentLessonCommentsScreen> {
  ...
  Future<void> _sendComment() async {
    ...
    final newComment = LessonCommentModel(
      ...
      senderStudentId: StudentCache.currentStudent?.id,
      message: text,
  ...
  Widget _buildCommentBubble(LessonCommentModel comment) {
    final isMe = comment.senderStudentId == StudentCache.currentStudent?.id;
    final align = isMe ? CrossAxisAlignment.end : CrossAxisAlignment.start;
    final bubbleColor = isMe ? Colors.green.shade100 : Colors.grey.shade200;
