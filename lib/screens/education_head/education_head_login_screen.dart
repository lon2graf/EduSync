...
class EducationHeadLoginScreen extends StatefulWidget {
  ...
  @override
  _EducationHeadLoginScreenState createState() =>
      _EducationHeadLoginScreenState();
}

class _EducationHeadLoginScreenState extends State<EducationHeadLoginScreen> {
  ...
  void _login() async {
    ...
    final success = await EducationHeadServives.loginEducationHead(
      email,
      password,
    );
